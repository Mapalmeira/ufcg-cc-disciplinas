  ...
  return <div className="modal-backdrop" onMouseDown={(event) => event.target === event.currentTarget && onClose()}>
    <section className="detail-modal" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      ...
      <div className="modal-content">
        ...
        <section className="detail-section requirement-section direct-dependencies-section"><h3>Dependências diretas</h3>{renderCourseList(directDependents, "Nenhuma")}</section>
        <section className="detail-section requirement-section indirect-dependencies-section"><h3>Dependências indiretas</h3>{renderCourseList(indirectDependents, "Nenhuma")}</section>
      </div>
    </section>
  </div>;
}
