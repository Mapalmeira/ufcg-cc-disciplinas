...
- [PPC 2023 course catalog](https://github.com/daltonserey/ppc-2023-em-dados/blob/master/dados/disciplinas.json): descriptions, hours, credits, and responsible academic units.
- [PPC 2023 curriculum matrix](https://docs.google.com/spreadsheets/d/1eMhue4891tuD8pUGYlB2fWpWXDtbGE2IEyNEgy28pHM/edit): terms, course types, tracks, prerequisites, and corequisites.
- [2026.2 class schedule](https://docs.google.com/spreadsheets/d/10kUHJNiyvzLC20LcIwiTdkDXkbAEy9mPUvr8gzwo688/edit): sections, instructors, rooms, and course codes.
